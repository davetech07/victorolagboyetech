export const portfolioData = {
    ...
    intro: "I build interfaces that feel calm on the surface and fast underneath, with thoughtful UX, maintainable architecture, and measurable outcomes.",
    highlight:
...
export const contactForm = {
    ...
    errorMessage: "Could not send right now. Please try again or use email/WhatsApp."
};
